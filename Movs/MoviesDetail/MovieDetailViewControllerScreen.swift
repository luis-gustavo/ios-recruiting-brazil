...
extension MovieDetailViewControllerScreen: ViewCodable {
    ...
    func setupConstraints() {
        // Movie image
        movieImage.topAnchor.constraint(equalTo: self.topAnchor, constant: frame.size.height * 0.03).isActive = true
        ...
        // Name label
        nameLabel.topAnchor.constraint(equalTo: movieImage.bottomAnchor, constant: frame.size.height * 0.03).isActive = true
        ...
        divisorView1.topAnchor.constraint(equalTo: self.nameLabel.bottomAnchor, constant: frame.size.height * 0.03).isActive = true
        ...
        // Year label
        yearLabel.topAnchor.constraint(equalTo: self.divisorView1.bottomAnchor, constant: frame.size.height * 0.03).isActive = true
        ...
        divisorView2.topAnchor.constraint(equalTo: self.yearLabel.bottomAnchor, constant: frame.size.height * 0.03).isActive = true
        ...
        // Genre label
        genreLabel.topAnchor.constraint(equalTo: self.divisorView2.bottomAnchor, constant: frame.size.height * 0.03).isActive = true
        ...
        divisorView3.topAnchor.constraint(equalTo: self.genreLabel.bottomAnchor, constant: frame.size.height * 0.03).isActive = true
        ...
        // Summary label
        summaryLabel.topAnchor.constraint(equalTo: self.divisorView2.bottomAnchor, constant: frame.size.height * 0.03).isActive = true
        ...
        summaryLabel.trailingAnchor.constraint(equalTo: self.trailingAnchor, constant: -frame.size.width * 0.05).isActive = true
    }
    ...
    func setupAdditionalConfiguration() {
        ...
        yearLabel.text = "2008"
        nameLabel.text = "Thor"
        genreLabel.text = "Action, Horror"
        summaryLabel.text = "This is by far the best movie from Marvel Studios. Thor is much stronger then Hulk. And I don't give a shit about Iron Man"
